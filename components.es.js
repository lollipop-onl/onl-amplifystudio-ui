...
((o = globalThis.litElementVersions) !== null && o !== void 0 ? o : globalThis.litElementVersions = []).push("3.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var styles = "div p{line-clamp:3;text-decoration:underline}\n";
...
let OnlHeader = class extends s {
  render() {
    return $`<div><p>Hello World ${this.name}</p></div>`;
  }
};
OnlHeader.styles = o$3(styles);
__decorateClass([
  e({ type: String })
], OnlHeader.prototype, "name", 2);
